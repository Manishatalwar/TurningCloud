const Traceback = () => {
  return (
    <div className="flex-1 flex flex-col items-start justify-start min-w-[200px] max-w-[204px] text-left text-4xs text-white font-poppins">
      <div className="self-stretch flex flex-col items-start justify-start pt-0 px-0 pb-[43.599999999999994px] relative gap-[88.7px]">
        <img
        ...
        <div className="flex flex-row items-start justify-start py-0 pr-[13px] pl-[12.600000000000025px]">
          <img
      ...
      <div className="self-stretch bg-white flex flex-col items-start justify-start pt-[11px] pb-[10.399999999999975px] pr-[11.200000000000044px] pl-3 gap-[1px] z-[2] mt-[-33px] text-gray-500">
        ...
        <div className="self-stretch flex flex-col items-start justify-start gap-[9px_0px]">
          <div className="w-[149.8px] flex flex-row items-start justify-start gap-[0px_5px]">
            <div className="flex-1 rounded-sm bg-white flex flex-row items-start justify-start py-0 pr-px pl-[3px] gap-[0px_3px] z-[1] border-[1px] border-solid border-orange">
        ...
        <div className="w-[176.7px] flex flex-row items-start justify-start pt-0 px-0 pb-1 box-border text-xs">
          <div className="flex-1 relative font-medium z-[1]">
            Mens white check Shirt regular fit
          </div>
        </div>
        <div className="self-stretch flex flex-col items-start justify-start pt-0 px-0 pb-[9px] gap-[13px_0px]">
          ...
          <div className="flex flex-row items-start justify-start gap-[0px_11px] text-xs">
